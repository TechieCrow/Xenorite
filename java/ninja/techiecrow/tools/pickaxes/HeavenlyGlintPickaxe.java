...
public class HeavenlyGlintPickaxe extends PickaxeXenorite
{
	...
	{
		super(material);
		this.setUnlocalizedName("heavenlyglintPickaxe");
	...
	public ItemStack onItemRightClick(ItemStack ItemStack, World World, EntityPlayer EntityPlayer)
	{
		...
		if (tag.getBoolean("isActive"))
		{
			...
			EntityPlayer.addPotionEffect((new PotionEffect(ConfigurationHandler.pickaxeHeavenlyGlintEffect1, 0, 0)));
		}
	...
	public void onUpdate(ItemStack ItemStack, World World, Entity Entity, int par1, boolean par2)
	{
		...
		{
			par3EntityPlayer.addPotionEffect((new PotionEffect(ConfigurationHandler.pickaxeHeavenlyGlintEffect1, 0, 0)));
		}
