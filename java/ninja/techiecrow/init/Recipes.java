...
public class Recipes
{
	public static void init()
	{
		...
		// Xenorite Block
		GameRegistry.addShapedRecipe(new ItemStack(ModBlocks.xenoriteBlock), "III", "III", "III", 'I', ninja.techiecrow.init.ModItems.xenoriteIngot);
		// Coreorite Block
		GameRegistry.addShapedRecipe(new ItemStack(ModBlocks.coreoriteBlock), "III", "III", "III", 'I', ninja.techiecrow.init.ModItems.coreoriteIngot);
		// Finorite Block
		GameRegistry.addShapedRecipe(new ItemStack(ModBlocks.finoriteBlock), "III", "III", "III", 'I', ninja.techiecrow.init.ModItems.finoriteIngot);
		// HeavenlyGlint Block
		GameRegistry.addShapedRecipe(new ItemStack(ModBlocks.heavenlyglintBlock), "III", "III", "III", 'I', ninja.techiecrow.init.ModItems.heavenlyglintIngot);
		// ShadowBoron Block
		GameRegistry.addShapedRecipe(new ItemStack(ModBlocks.shadowboronBlock), "III", "III", "III", 'I', ninja.techiecrow.init.ModItems.shadowboronIngot);
