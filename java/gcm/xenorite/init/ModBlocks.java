...
public class ModBlocks
{
	...
	public static void init()
	{
		...
		GameRegistry.addShapedRecipe(new ItemStack(xenoriteBlock), "III", "III", "III", 'I', gcm.xenorite.init.ModItems.xenoriteIngot);

		GameRegistry.registerBlock(coreoriteBlock, "coreoriteBlock");
		GameRegistry.addShapedRecipe(new ItemStack(coreoriteBlock), "III", "III", "III", 'I', gcm.xenorite.init.ModItems.coreoriteIngot);

		GameRegistry.registerBlock(finoriteBlock, "finoriteBlock");
		GameRegistry.addShapedRecipe(new ItemStack(finoriteBlock), "III", "III", "III", 'I', gcm.xenorite.init.ModItems.finoriteIngot);

		GameRegistry.registerBlock(heavenlyglintBlock, "heavenlyglintBlock");
		GameRegistry.addShapedRecipe(new ItemStack(heavenlyglintBlock), "III", "III", "III", 'I', gcm.xenorite.init.ModItems.heavenlyglintIngot);

		GameRegistry.registerBlock(shadowboronBlock, "shadowboronBlock");
		GameRegistry.addShapedRecipe(new ItemStack(shadowboronBlock), "III", "III", "III", 'I', gcm.xenorite.init.ModItems.shadowboronIngot);
	}
}