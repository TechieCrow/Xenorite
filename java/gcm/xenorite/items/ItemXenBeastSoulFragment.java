...
public class ItemXenBeastSoulFragment extends ItemXenorite
{
	...
	/*public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List List, boolean par3)
    {
        ...
        {
            {
            	List.add(String.format("§7A small fragment of a Xen Beasts soul."));
            	List.add(String.format("§7Activating & carrying this with you will grant the ablilty to run faster!"));
            }
        } else
        {
