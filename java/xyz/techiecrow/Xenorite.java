...
import xyz.techiecrow.entitys.XenBeastRegistry;
import xyz.techiecrow.handler.ConfigurationHandler;
import xyz.techiecrow.handler.EventHandler;
import xyz.techiecrow.handler.UpdateHandler;
import xyz.techiecrow.init.ModAxes;
import xyz.techiecrow.init.ModBlockOres;
import xyz.techiecrow.init.ModBlocks;
import xyz.techiecrow.init.ModChestGenHooks;
import xyz.techiecrow.init.ModHoes;
import xyz.techiecrow.init.ModItems;
import xyz.techiecrow.init.ModPickaxes;
import xyz.techiecrow.init.ModShovels;
import xyz.techiecrow.init.ModWeapons;
import xyz.techiecrow.init.Recipes;
import xyz.techiecrow.proxy.IProxy;
