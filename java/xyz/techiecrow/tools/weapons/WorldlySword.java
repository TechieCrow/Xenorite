...
public class WorldlySword extends WeaponXenorite
{
	...
	public ItemStack onItemRightClick(ItemStack ItemStack, World World, EntityPlayer EntityPlayer)
	{
		...
		if (tag.getBoolean("isActive"))
		{
			...
			{
				if (rand < 0.5)
					EntityPlayer.addPotionEffect(new PotionEffect(5, 0, 2));
			}
		}
	...
	public void onUpdate(ItemStack ItemStack, World World, Entity Entity, int par1, boolean par2)
	{
		...
		{
			par3EntityPlayer.addPotionEffect((new PotionEffect(5, 0, 2)));
		}
	...
	public void addInformation(ItemStack ItemStack, EntityPlayer EntityPlayer, List List, boolean par4)
	{
		...
		if (!(ItemStack.getTagCompound() == null))
		{
			...
			{
				List.add(String.format("\u00A7b\u00A7o\u00A7lWorldly Sword Sword Activated"));
			}
			else
			{
				List.add(String.format("\u00A7b\u00A7o\u00A7lWorldly Sword Not Activated"));
			}
		}
	}
}