...
public class PeacefulGlintingShadowPickaxe extends PickaxeXenorite
{
	...
	public ItemStack onItemRightClick(ItemStack ItemStack, World World, EntityPlayer EntityPlayer)
	{
		...
		if (tag.getBoolean("isActive"))
		{
			...
			EntityPlayer.addPotionEffect((new PotionEffect(3, 0, 1)));
		}
	...
	public void onUpdate(ItemStack ItemStack, World World, Entity Entity, int par1, boolean par2)
	{
		...
		{
			par3EntityPlayer.addPotionEffect((new PotionEffect(3, 0, 1)));
		}
	...
	public void addInformation(ItemStack ItemStack, EntityPlayer EntityPlayer, List List, boolean par4)
	{
		...
		if (!(ItemStack.getTagCompound() == null))
		{
			...
			{
				List.add(String.format("\u00A7b\u00A7o\u00A7lPeaceful Glinting Shadow Pickaxe Activated"));
			}
			else
			{
				List.add(String.format("\u00A7b\u00A7o\u00A7lPeaceful Glinting Shadow Pickaxe Not Activated"));
			}
		}
	}
}