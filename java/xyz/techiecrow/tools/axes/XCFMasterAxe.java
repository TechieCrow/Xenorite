package xyz.techiecrow.tools.axes;

public class XCFMasterAxe extends AxeXenorite
{
	public XCFMasterAxe(ToolMaterial material)
	{
		super(material);
		this.setUnlocalizedName("xcfMasterAxe");
