...
public class EnderPigRegistry
{
	public static void registerEntity(Class entityClass, String name)
	{
		...
		EntityRegistry.addSpawn(EnderPigEntity.class, spawnRateconfig, minSpawnconfig, maxSpawnconfig, EnumCreatureType.monster, new BiomeGenBase[]
		...
		DungeonHooks.addDungeonMob("EnderPigEntity", 180);
	}
}