...
public class ConfigurationHandler
{
	...
	private static void loadConfiguration()
	{
		...
		xenbeastSpeed = configuration.get(category, "Xen Beast Speed", 0.14, "(Default: 0.14)").getDouble(0.14);
		...
		xenbeastMaxSpawn = configuration.get(category, "Xen Beast Maximum To Spawn", 2, "(Default: 2)").getInt(2);
		...
		appleHeavenlyGlintDropChance = configuration.get(category, "Heavenly Glint Apple Drop Chance", 0.001, "0.01 = 1%, 1.0 = 100%, etc. (Default: 0.001)").getDouble(0.001);
